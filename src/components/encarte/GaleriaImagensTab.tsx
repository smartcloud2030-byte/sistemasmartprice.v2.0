...
import { Upload, Loader2, Repeat, Trash2 } from 'lucide-react';
 ...
 */
export default function GaleriaImagensTab({ titulo, subtitulo, icon: Icon, categoria, onAdicionarImagem }: GaleriaImagensTabProps) {
